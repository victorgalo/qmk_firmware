...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_FN0] = LAYOUT_60_iso(
        ...
        KC_LCTL, KC_LWIN,  KC_LALT,                            LT(1, KC_SPC),                       KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RIGHT),

    [_FN1] = LAYOUT_60_iso(
        KC_GRV,  KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_BSPC,
        KC_TAB,  KC_Q,     KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_BSPC, KC_UP,   KC_O,     KC_P,     KC_LBRC,  KC_RBRC,
        KC_CAPS, KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_ENT,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,
        KC_LSFT, KC_NUBS,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,            MT(MOD_RSFT, KC_UP),
        KC_LCTL, KC_LWIN,  KC_LALT,                            KC_SPC,                              KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RIGHT),
