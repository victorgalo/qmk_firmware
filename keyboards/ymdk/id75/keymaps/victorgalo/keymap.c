...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BASE_WIN] = LAYOUT_ortho_5x15(
    KC_ESC,                 KC_1,                   KC_2,                   KC_3,                   KC_4,                  KC_5,                            KC_KP_SLASH,                MO(_SWITCHER),              KC_KP_MINUS,                KC_6,                           KC_7,                   KC_8,                   KC_9,                   KC_0,                   KC_GRV,
    KC_TAB,                 KC_Q,                   KC_W,                   KC_E,                   KC_R,                  KC_T,                            KC_LBRC,                    KC_RBRC,                    KC_BSPC,                    KC_Y,                           KC_U,                   KC_I,                   KC_O,                   KC_P,                   KC_BSPC,
    QK_LEAD,                SFT_A,                  GUI_S,                  CTL_D,                  ALT_F,                 KC_G,                            KC_QUOT,                    KC_ENT,                     KC_ENT,                     KC_H,                           ALT_J,                  CTL_K,                  GUI_L,                  SFT_SCLN,               KC_ENT,
    KC_LSFT,                KC_Z,                   KC_X,                   KC_C,                   KC_V,                  KC_B,                            KC_RSFT,                    KC_RSFT,                    KC_UP,                      KC_N,                           KC_M,                   KC_COMM,                KC_DOT,                 KC_SLSH,                KC_RSFT,
    KC_LCTL,                KC_LWIN,                KC_LALT,                MO(_FUNC),              MO(_NUM),              LT(_SYM,  KC_ENT),               KC_RCTL,                    KC_LEFT,                    KC_DOWN,                    LT(_NAV,  KC_SPC),              KC_BSPC,                KC_SPC,                 KC_RALT,                KC_RCTL,                KC_RGHT
 ),
  ...
  [_BASE_MAC] = LAYOUT_ortho_5x15(
    ...
    QK_LEAD,                SFT_A,                  GUI_S,                  CTL_D,                  ALT_F,                 KC_G,                            KC_QUOT,                    KC_ENT,                     KC_ENT,                     KC_H,                           ALT_J,                  CTL_K,                  GUI_L,                  SFT_SCLN,               KC_ENT,
    KC_LSFT,                KC_Z,                   KC_X,                   KC_C,                   KC_V,                  KC_B,                            KC_RSFT,                    KC_RSFT,                    KC_UP,                      KC_N,                           KC_M,                   KC_COMM,                KC_DOT,                 KC_SLSH,                KC_RSFT,
    KC_LCTL,                KC_LALT                 KC_LWIN,                MO(_FUNC),              MO(_NUM),              LT(_SYM,  KC_ENT),               KC_RCTL,                    KC_LEFT,                    KC_DOWN,                    LT(_NAV,  KC_SPC),              KC_BSPC,                KC_SPC,                 KC_RALT,                KC_RCTL,                KC_RGHT
 ),
