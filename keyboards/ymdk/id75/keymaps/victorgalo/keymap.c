...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BASE_WIN] = LAYOUT_ortho_5x15(
    ...
    SC_LSPO,                KC_Z,                   KC_X,                   KC_C,                   KC_V,                  KC_B,                            KC_NO,                      KC_NO,                      KC_NO,                      KC_N,                           KC_M,                   KC_COMM,                KC_DOT,                 KC_SLSH,                asdasd,
    KC_LCTL,                KC_LCTL,                KC_LWIN,                KC_LALT,                MO(_SYM),              LT(_NUM, KC_ENT),                KC_NO,                      MO(_FUNC),                  KC_NO,                      KC_SPC,                         LT(_NAV, KC_BSPC),      KC_RALT,                KC_DOWN,                KC_UP,                  MO(_MEDIA)
 ),

 [_BASE_MAC] = LAYOUT_ortho_5x15(
    KC_ESC,                 KC_1,                   KC_2,                   KC_3,                   KC_4,                  KC_5,                            KC_KP_SLASH,                MO(_SWITCHER),              MO(_MEDIA),                 KC_6,                           KC_7,                   KC_8,                   KC_9,                   KC_0,                   KC_BSPC,
    KC_TAB,                 KC_Q,                   KC_W,                   KC_E,                   KC_R,                  KC_T,                            KC_NO,                      KC_NO,                      KC_NO,                      KC_Y,                           KC_U,                   KC_I,                   KC_O,                   KC_P,                   KC_BSPC,
    QK_LEAD,                SFT_A,                  CTL_S,                  GUI_D,                  ALT_F,                 KC_G,                            KC_NO,                      KC_NO,                      KC_NO,                      KC_H,                           ALT_J,                  GUI_K,                  CTL_L,                  SFT_SCLN,               KC_QUOT,
    SC_LSPO,                KC_Z,                   KC_X,                   KC_C,                   KC_V,                  KC_B,                            KC_NO,                      KC_NO,                      KC_NO,                      KC_N,                           KC_M,                   KC_COMM,                KC_DOT,                 KC_SLSH,                SC_RSPC,
    KC_LCTL,                KC_LCTL,                KC_LALT,                KC_LWIN,                MO(_SYM),              LT(_NUM, KC_ENT),                KC_NO,                      MO(_FUNC),                  KC_NO,                      KC_SPC,                         LT(_NAV, KC_BSPC),      KC_RALT,                KC_DOWN,                KC_UP,                  MO(_MEDIA)
 ),

 [_SWITCHER] = LAYOUT_ortho_5x15(
    KC_TRNS,                TO(_BASE_WIN),          TO(_BASE_MAC),          KC_TRNS,                TO(_GAMING),               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
 ...
 [_NAV] = LAYOUT_ortho_5x15(
    KC_GRV,                 KC_F1,                  KC_F2,                  KC_F3,                  KC_F4,                 KC_F5,                           KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_F6,                          KC_F7,                  KC_F8,                  KC_F9,                  KC_F10,                 KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                QK_REP,                QK_AREP,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PGUP,                        KC_HOME,                KC_UP,                  KC_END,                 KC_BSPC,                KC_DEL,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PGDN,                        KC_LEFT,                KC_DOWN,                KC_RIGHT,               KC_ENT,                 KC_ENT,
    KC_TRNS,                QK_UNDO,                QK_CUT,                 QK_COPY,                QK_PASTE,              KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    QK_REP,                         QK_AREP,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS
 ),
 ...
 [_SYM] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               QK_REDO,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_MINS,                        KC_EQL,                 KC_LBRC,                KC_RBRC,                KC_BSLS,                KC_GRV,
    KC_TRNS,                QK_UNDO,                QK_CUT,                 QK_COPY,                QK_PASTE,              KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_UNDS,                        KC_PLUS,                KC_LCBR,                KC_RCBR,                KC_PIPE,                KC_TILDE,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_DEL,                     KC_TRNS,                        KC_RALT,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS
),
 ...
 [_NUM] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_ENT,                          KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_MINS,                        KC_P4,                  KC_P5,                  KC_P6,                  KC_EQL,                 KC_SLSH,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_BSPC,                KC_DEL,                KC_ENT,                          KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PLUS,                        KC_P1,                  KC_P2,                  KC_P3,                  KC_DOT,                 KC_TRNS,
 ...
 [_FUNC] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_F6,                  KC_F7,                  KC_F8,                  KC_F9,                 KC_F10,                           KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_F12,
 ...
 [_GAMING] = LAYOUT_ortho_5x15(
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_A,                   KC_S,                   KC_D,                   KC_F,                   KC_G,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                      KC_H,                           KC_J,                   KC_K,                   KC_L,                   KC_SCLN,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS
),
...
[_MEDIA] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    NK_TOGG,                        KC_APP ,                KC_TRNS,                KC_UP,                KC_TRNS,                KC_TRNS,
