...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BASE_WIN] = LAYOUT_ortho_5x15(
    ...
    KC_LCTL,                KC_LCTL,                KC_LWIN,                KC_LALT,                MO(_FUNC),             MO(_SYM),                        LT(_NUM, KC_ENT),           KC_NO,                      KC_BSPC,                    LT(_NAV,  KC_SPC),              KC_RALT,                KC_LEFT,                KC_DOWN,                KC_UP,                  KC_RIGHT
 ),
 ...
 [_BASE_MAC] = LAYOUT_ortho_5x15(
    ...
    SC_LSPO,                KC_Z,                   KC_X,                   KC_C,                   KC_V,                  KC_B,                            KC_NO,                      KC_NO,                      KC_NO,                      KC_N,                           KC_M,                   KC_COMM,                KC_DOT,                 KC_SLSH,                SC_RSPC,
    KC_LCTL,                KC_LCTL,                KC_LALT,                KC_LWIN,                MO(_FUNC),             MO(_SYM),                        LT(_NUM, KC_ENT),           KC_NO,                      KC_BSPC,                    LT(_NAV,  KC_SPC),              KC_RALT,                KC_LEFT,                KC_DOWN,                KC_UP,                  KC_RIGHT
 ),
 ...
 [_NAV] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                QK_REP,                QK_AREP,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PGUP,                        KC_HOME,                KC_UP,                  KC_END,                 KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PGDN,                        KC_LEFT,                KC_DOWN,                KC_RIGHT,               KC_ENT,                 KC_TRNS,
    KC_TRNS,                QK_UNDO,                QK_CUT,                 QK_COPY,                QK_PASTE,              KC_SPC,                          KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    QK_REP,                         QK_AREP,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_TRNS,                         KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_TRNS,                        KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS
 ),
 ...
 [_NUM] = LAYOUT_ortho_5x15(
    ...
    KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,                KC_TRNS,               KC_ENT,                          KC_TRNS,                    KC_TRNS,                    KC_TRNS,                    KC_PLUS,                        KC_P1,                  KC_P2,                  KC_P3,                  KC_DOT,                 KC_TRNS,
